...
#endif
static struct omap_board_config_kernel cm335x_config[] __initdata = {
};
...
static struct pinmux_config gpio_wg_mux[] = {
...
/*GPIO1_14 intterupt*/
static struct pinmux_config gpio_int_mux[] = {
...
/*GPIO1_14 interrupt*/
static void gpio_interrupt_init(int evm_id, int profile)
{
        setup_pin_mux(gpio_int_mux);
        return;
}
...
static struct wg_info gpio_wg_info ={
	.wg0_data0 = GPIO_TO_PIN(1, 25),
	.wg0_data1 = GPIO_TO_PIN(1, 27),
	.wg1_data0 = GPIO_TO_PIN(1, 24),
	.wg1_data1 = GPIO_TO_PIN(1, 23),
};
 
static struct platform_device cm335x_wg_gpio = {
	.name = "gpio_wg",
	.id   = -1,
	.dev = {
	       .platform_data = &gpio_wg_info,
	},

};


 static void gpio_wg_init(int evm_id, int profile)
 {
         int err;

         setup_pin_mux(gpio_wg_mux);
         err = platform_device_register(&cm335x_wg_gpio);
         if (err)
                 pr_err("failed to register gpio wg device\n");
 }
...
static struct evm_dev_cfg cm335x_dev_cfg[] = {
	...
	{gpio_wg_init,      DEV_ON_BASEBOARD, PROFILE_ALL},
	{gpio_interrupt_init,      DEV_ON_BASEBOARD, PROFILE_ALL},
        {NULL, 0, 0},
};
...
static void __init cm335x_i2c_init(void)
{
/*	evm_init_cpld();*/
...
static void __init cm335x_init(void)
{
	am33xx_cpuidle_init();
	...
	omap_board_config = cm335x_config;
	omap_board_config_size = ARRAY_SIZE(cm335x_config);
...
static void __init cm335x_map_io(void)
{
	omap2_set_globals_am33xx();
	omapam33xx_map_common_io();
}

//MACHINE_START(CM335X, "cm335x")
MACHINE_START(AM335XEVM, "am335xevm")
	.atag_offset	= 0x100,
	.map_io		= cm335x_map_io,
	.init_early	= am33xx_init_early,
	.init_irq	= ti81xx_init_irq,
	.handle_irq     = omap3_intc_handle_irq,
	.timer		= &omap3_am33xx_timer,
	.init_machine	= cm335x_init,
MACHINE_END
