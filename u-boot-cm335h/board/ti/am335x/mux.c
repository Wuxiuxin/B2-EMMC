...
static struct module_pin_mux led_pwm_back[] = {
	{OFFSET(mcasp0_ahclkr),MODE(7) | PULLUDEN | PULLUP_EN}, 
};

static struct module_pin_mux gpmc_a2_gpio[] ={
	{OFFSET(gpmc_a2), (MODE(7) | PULLUDEN) },
};
...
static struct module_pin_mux spi_gpio_mux[] ={
        {OFFSET(spi0_sclk), (MODE(7) | PULLUDEN) },
        {OFFSET(spi0_d0), (MODE(7) | PULLUDEN | RXACTIVE) },
        {OFFSET(spi0_cs0), (MODE(7) | PULLUDEN) },
        {-1},
};
...
static struct module_pin_mux lcd_pin_mux[] = {
        {OFFSET(lcd_data0), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data1), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data2), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data3), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data4), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data5), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data6), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data7), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data8), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data9), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data10), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data11), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data12), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data13), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data14), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_data15), MODE(0) | PULLUDDIS | RXACTIVE},
        {OFFSET(lcd_vsync), MODE(0) | RXACTIVE},
        {OFFSET(lcd_hsync), MODE(0) | RXACTIVE},
        {OFFSET(lcd_pclk),MODE(0) | RXACTIVE},
        {OFFSET(lcd_ac_bias_en),MODE(0) | RXACTIVE},
        {-1},
};
...
void enable_board_pin_mux(struct am335x_baseboard_id *header)
{
	...
	//	configure_module_pin_mux(gpio0_7_pin_mux);
		...
		configure_module_pin_mux(mmc0_pin_mux);
		configure_module_pin_mux(mmc1_pin_mux);
		configure_module_pin_mux(led_pwm_back);
		configure_module_pin_mux(lcd_pin_mux);

		configure_module_pin_mux(spi_gpio_mux);
	#if 0
